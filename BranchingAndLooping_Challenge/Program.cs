                ...
                case "3":
                    for (int i = 0; i < maxPets; i++)
                    {
                        ...
                        if (ourAnimals[i, 2] == "Age: ?")
                        {
                            ...
                            do
                            {
                                Console.Write($"Pet age for {petID}? ");
                                inputAge = Console.ReadLine();
                            ...
                            } while (!int.TryParse(inputAge, out _));

                            ourAnimals[i, 2] = "Age: " + inputAge;
                        }

                        if (ourAnimals[i, 4] == "Physical Desc.: tbd.")
                        {
                            string? inputPhysicalDescription;
                            do
                            {
                                Console.WriteLine($"Pet physical desc. for {petID} (size, color, gender, weight, housebroken):");
                                inputPhysicalDescription = Console.ReadLine();
                            } while (string.IsNullOrWhiteSpace(inputPhysicalDescription));

                            ourAnimals[i, 4] = "Physical Desc.: " + inputPhysicalDescription.ToLower();
                        }
                    }
                ...
                case "4":
                    for (int i = 0; i < maxPets; i++)
                    {
                        ...
                        if (ourAnimals[i, 3] == "Nickname: tbd.")
                        {
                            ...
                            do
                            {
                                Console.Write($"Pet nickname for {petID}? ");
                                inputNickname = Console.ReadLine();
                            } while (string.IsNullOrWhiteSpace(inputNickname));

                            ourAnimals[i, 3] = "Nickname: " + inputNickname.ToLower();
                        }
                        ...
                        if (ourAnimals[i, 5] == "Personality: tbd.")
                        {
                            ...
                            do
                            {
                                Console.WriteLine($"Pet personality for {petID} (likes/dislikes, tricks, energy level):");
                                inputPersonality = Console.ReadLine();
                            } while (string.IsNullOrWhiteSpace(inputPersonality));

                            ourAnimals[i, 5] = "Personality: " + inputPersonality.ToLower();
                        }
                    }
